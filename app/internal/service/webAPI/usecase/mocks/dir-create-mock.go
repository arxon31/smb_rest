...
func (m *MockDirectoryCreator) CreateDir(ctx context.Context, dirs []string) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateDir", ctx, dirs)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDirectoryCreatorMockRecorder) CreateDir(ctx, dirs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateDir", reflect.TypeOf((*MockDirectoryCreator)(nil).CreateDir), ctx, dirs)
}
